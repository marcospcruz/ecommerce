...
class PacoteFreteTO{
	...
	private function reportaEspacoVazio(){
		$alturaPacote=$this->dimensaoPacote[self::EIXO_Y];
		$comprimentoPacote=$this->dimensaoPacote[self::EIXO_X];
		$larguraPacote=$this->dimensaoPacote[self::EIXO_Z];

		/*$this->imprime("=========");
		$this->imprime("altura:".($this->ultimaAlturaPreenchida-$alturaPacote));
		$this->imprime("comprimento:".($this->ultimoComprimentoPreenchido-$comprimentoPacote));
		$this->imprime("largura:".$this->ultimaLarguraPreenchida);
		$this->imprime("=========");*/
	}
